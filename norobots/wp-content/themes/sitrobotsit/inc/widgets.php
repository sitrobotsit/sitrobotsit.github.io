...
class SitRobotSit_Ephemera_Widget extends WP_Widget {
	 ...
	 * @since Sit Robot Sit 1.0
	 *
	 * @return SitRobotSit_Ephemera_Widget
	 */
	public function __construct() {
		parent::__construct( 'widget_twentyfourteen_ephemera', __( 'Sit Robot Sit Ephemera', 'twentyfourteen' ), array(
