 ...
 *
 * Galleries are styled by the theme in Sit Robot Sit's style.css. This is just
 * a simple filter call that tells WordPress to not use the default styles.
 *
 * @since Sit Robot Sit 1.2
 */
 ...
 *
 * @since Sit Robot Sit 1.0
 * @deprecated Deprecated in Sit Robot Sit 1.2 for WordPress 3.1
 *
 ...
 * to remove the default style. Using Sit Robot Sit 1.2 in WordPress 3.0 will show the styles,
 * but they won't have any effect on the widget in default Sit Robot Sit styling.
 *
 * @since Sit Robot Sit 1.0
 */
